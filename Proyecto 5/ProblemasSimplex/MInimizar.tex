...
\textbf{Variables básicas:} $x_{1}$, $s_{1}$, $x_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & 0 & -0.50 & 1,0M & 1,0M & -5.40 \\
\hline
$x_{1}$ & 1 & 0 & 0 & -5 & -4 & 5 & 6 \\
\hline
$s_{1}$ & 0 & 0 & 1 & 1 & 0.60 & -1 & 0.30 \\
\hline
$x_{2}$ & 0 & 1 & 0 & 5 & 6 & -5 & 6 \\
\hline
\end{tabular}
...
\textbf{Valor óptimo de Z:} $\mathbf{-5,40}$\\
...
El valor óptimo de la función objetivo es: \textbf{Z = -5,40}\\
