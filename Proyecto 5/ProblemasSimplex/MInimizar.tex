...
\[
Minimizar Z = 0.40x_{1} + 0.50x_{2}
\]

\subsection{Restricciones}
\[
\begin{cases}
0.30x_{1} + 0.10x_{2} \leq 2.70 \\
0.50x_{1} + 0.50x_{2} = 6 \\
0.60x_{1} + 0.40x_{2} \geq 6
\end{cases}
\]
...
\hline
Z & 1,1M & 0,9M & 0 & -M & 2M & 2M & 12M \\
\hline
$s_{1}$ & 0.30 & 0.10 & 1 & 0 & 0 & 0 & 2.70 \\
\hline
$a_{1}$ & 0.50 & 0.50 & 0 & 0 & 1 & 0 & 6 \\
\hline
$a_{2}$ & 0.60 & 0.40 & 0 & -1 & 0 & 1 & 6 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Iteración:} 2\\
\textbf{Variables básicas:} $x_{1}$, $a_{1}$, $a_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0,5M & -3,7M & -M & 2M & 2M & 2,1M \\
\hline
$x_{1}$ & 1 & 0.33 & 3.33 & 0 & 0 & 0 & 9 \\
\hline
$a_{1}$ & 0 & 0.33 & -1.67 & 0 & 1 & 0 & 1.50 \\
\hline
$a_{2}$ & 0 & 0.20 & -2 & -1 & 0 & 1 & 0.60 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Iteración:} 3\\
\textbf{Variables básicas:} $x_{1}$, $a_{1}$, $x_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & 1,7M & 1,7M & 2M & -0,7M & 0,5M \\
\hline
$x_{1}$ & 1 & 0 & 6.67 & 1.67 & 0 & -1.67 & 8 \\
\hline
$a_{1}$ & 0 & 0 & 1.67 & 1.67 & 1 & -1.67 & 0.50 \\
\hline
$x_{2}$ & 0 & 1 & -10 & -5 & 0 & 5 & 3 \\
\hline
\end{tabular}
...
\textbf{Variables básicas:} $x_{1}$, $e_{1}$, $x_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & -0.50 & 0 & 1,0M & M & 5.25 \\
\hline
$x_{1}$ & 1 & 0 & 5 & 0 & -1 & 0 & 7.50 \\
\hline
$e_{1}$ & 0 & 0 & 1 & 1 & 0.60 & -1 & 0.30 \\
\hline
$x_{2}$ & 0 & 1 & -5 & 0 & 3 & 0 & 4.50 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de Z:} $\mathbf{5,25}$\\
...
El valor óptimo de la función objetivo es: \textbf{Z = 5,25}\\
