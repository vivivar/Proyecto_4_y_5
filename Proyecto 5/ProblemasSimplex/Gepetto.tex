...
\textbf{Iteración:} 2\\
\textbf{Variables básicas:} $s_{1}$, $s_{2}$, $x_{1}$\\
...
\textbf{Iteración:} 3\\
\textbf{Variables básicas:} $x_{2}$, $s_{2}$, $x_{1}$\\
...
\textbf{Variables básicas:} $x_{2}$, $s_{3}$, $x_{1}$\\
...
\textbf{Valor óptimo de Z:} $\mathbf{180,00}$\\
...
El valor óptimo de la función objetivo es: \textbf{Z = 180,00}\\
