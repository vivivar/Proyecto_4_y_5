...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 1,7M & 0 & -M & -0,3M & 2M & 2,0M \\
\hline
$x_{1}$ & 1 & 0.33 & 0 & 0 & 0.33 & 0 & 1 \\
\hline
$a_{2}$ & 0 & 1.67 & 0 & -1 & -1.33 & 1 & 2 \\
\hline
$s_{1}$ & 0 & 1.67 & 1 & 0 & -0.33 & 0 & 3 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Iteración:} 3\\
\textbf{Variables básicas:} $x_{1}$, $x_{2}$, $s_{1}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & 0 & 0.20 & 1,0M & 1,0M & 3.60 \\
\hline
$x_{1}$ & 1 & 0 & 0 & 0.20 & 0.60 & -0.20 & 0.60 \\
\hline
$x_{2}$ & 0 & 1 & 0 & -0.60 & -0.80 & 0.60 & 1.20 \\
\hline
$s_{1}$ & 0 & 0 & 1 & 1 & 1 & -1 & 1 \\
\hline
\end{tabular}
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & -0.20 & 0 & 1,0M & M & 3.40 \\
\hline
$x_{1}$ & 1 & 0 & -0.20 & 0 & 0.40 & 0 & 0.40 \\
\hline
$x_{2}$ & 0 & 1 & 0.60 & 0 & -0.20 & 0 & 1.80 \\
\hline
$e_{1}$ & 0 & 0 & 1 & 1 & 1 & -1 & 1 \\
\hline
\end{tabular}
