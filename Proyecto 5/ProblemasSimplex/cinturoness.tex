...
\textbf{Iteración:} 2\\
\textbf{Variables básicas:} $s_{1}$, $x_{2}$\\
...
Z & -1 & 0 & 0 & 2 & 120 \\
\hline
$s_{1}$ & 0.50 & 0 & 1 & -0.50 & 10 \\
\hline
$x_{2}$ & 0.50 & 1 & 0 & 0.50 & 30 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de Z:} $\mathbf{140,00}$\\
...
El valor óptimo de la función objetivo es: \textbf{Z = 140,00}\\
