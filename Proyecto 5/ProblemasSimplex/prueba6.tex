...
\hline
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$e_{1}$} & \textbf{$e_{2}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 4,0M & -2 & -M & -M & 2M & 2M & 12M \\
\hline
$a_{1}$ & 2 & -2 & -1 & 0 & 1 & 0 & 3 \\
\hline
$a_{2}$ & 2 & 2 & 0 & -1 & 0 & 1 & 9 \\
...
\textbf{Iteración:} 2\\
\textbf{Variables básicas:} $x_{1}$, $a_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$e_{1}$} & \textbf{$e_{2}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 4,0M & 1,0M & -M & 1.50 & 2M & 6,0M \\
\hline
$x_{1}$ & 1 & -1 & -0.50 & 0 & 0.50 & 0 & 1.50 \\
\hline
$a_{2}$ & 0 & 4 & 1 & -1 & -1 & 1 & 6 \\
\hline
\end{tabular}
...
\textbf{Variables básicas:} $x_{1}$, $x_{2}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$e_{1}$} & \textbf{$e_{2}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & -0.25 & -1.25 & 1,0M & 1,0M & 12 \\
\hline
$x_{1}$ & 1 & 0 & -0.25 & -0.25 & 0.25 & 0.25 & 3 \\
\hline
$x_{2}$ & 0 & 1 & 0.25 & -0.25 & -0.25 & 0.25 & 1.50 \\
\hline
\end{tabular}
\end{center}
