...
\[
Minimizar Z = 6x_{1} + 4x_{2} + 2x_{3}
\]

\subsection{Restricciones}
\[
\begin{cases}
6x_{1} + 2x_{2} + 6x_{3} \geq 6 \\
6x_{1} + 4x_{2} = 12 \\
2x_{1} - -2x_{2} \leq 2
\end{cases}
\]
...
\hline
Z & 12,0M & 6,0M & 6,0M & 0 & -M & 2M & 2M & 18M \\
\hline
$a_{1}$ & 6 & 2 & 6 & 0 & -1 & 1 & 0 & 6 \\
\hline
$a_{2}$ & 6 & 4 & 0 & 0 & 0 & 0 & 1 & 12 \\
\hline
$s_{1}$ & 2 & -2 & 0 & 1 & 0 & 0 & 0 & 2 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 2,0M & -6,0M & 0 & 1,0M & 1 & 2M & 6,0M \\
\hline
$x_{1}$ & 1 & 0.33 & 1 & 0 & -0.17 & 0.17 & 0 & 1 \\
\hline
$a_{2}$ & 0 & 2 & -6 & 0 & 1 & -1 & 1 & 6 \\
\hline
$s_{1}$ & 0 & -2.67 & -2 & 1 & 0.33 & -0.33 & 0 & 0 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Iteración:} 3\\
\textbf{Variables básicas:} $x_{2}$, $a_{2}$, $s_{1}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & -6,0M & 0 & -12,0M & 0 & 2,0M & -1,0M & 2M & 12 \\
\hline
$x_{2}$ & 3 & 1 & 3 & 0 & -0.50 & 0.50 & 0 & 3 \\
\hline
$a_{2}$ & -6 & 0 & -12 & 0 & 2 & -2 & 1 & 0 \\
\hline
$s_{1}$ & 8 & 0 & 6 & 1 & -1 & 1 & 0 & 8 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Variables básicas:} $x_{2}$, $e_{1}$, $s_{1}$\\
...
\textbf{Base} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$s_{1}$} & \textbf{$e_{1}$} & \textbf{$a_{1}$} & \textbf{$a_{2}$} & \textbf{b} \\
\hline
Z & 0 & 0 & -2 & 0 & 0 & M & 1,0M & 12 \\
\hline
$x_{2}$ & 1.50 & 1 & 0 & 0 & 0 & 0 & 0.25 & 3 \\
\hline
$e_{1}$ & -3 & 0 & -6 & 0 & 1 & -1 & 0.50 & 0 \\
\hline
$s_{1}$ & 5 & 0 & 0 & 1 & 0 & 0 & 0.50 & 8 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Variables básicas:} $x_{2}$, $e_{1}$, $x_{1}$\\
...
Z & 0 & 0 & -2 & 0 & 0 & M & 1,0M & 12 \\
\hline
$x_{2}$ & 0 & 1 & 0 & -0.30 & 0 & 0 & 0.10 & 0.60 \\
\hline
$e_{1}$ & 0 & 0 & -6 & 0.60 & 1 & -1 & 0.80 & 4.80 \\
\hline
$x_{1}$ & 1 & 0 & 0 & 0.20 & 0 & 0 & 0.10 & 1.60 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor de Z:} $8.40$ (mismo valor óptimo)\\
...
\textbf{Valor de Z:} $12$ (mismo valor óptimo)\\
...
\textbf{Valor de Z:} $15.60$ (mismo valor óptimo)\\
...
\textbf{Mensaje:} Solución óptima múltiple encontrada (problema degenerado)\\
