...
\large Problema: \textbf{Problema2}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\textbf{Z} & 1 & 0 & 0 & 0 & 3 & 6 \\
\hline
\textbf{$S_1$} & 0 & 8.50 & 0 & 1 & 0 & 28 \\
\hline
\textbf{$S_2$} & 0 & -0.50 & 1 & 0 & 1 & 1 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Z} & 0 & 0 & 0 & 3 & 6 \\
\hline
\textbf{$s_1$} & 8.50 & 0 & 1 & -3.50 & 28 \\
\hline
\textbf{$x_{2}$} & -0.50 & 1 & 0 & 0.50 & 1 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Z} & 0 & 0 & 0 & 3 & 6 \\
\hline
\textbf{$X1$} & 1 & 0 & 0.12 & -0.41 & 3.29 \\
\hline
\textbf{$X2$} & 0 & 1 & 0.06 & 0.29 & 2.65 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 6$
...
\textbf{Verificación: } $Z = 6$ (mismo valor óptimo)\par\smallskip
