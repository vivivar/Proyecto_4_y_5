...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{$S_3$} & \textbf{$S_4$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & \textcolor{red}{-60} & \textcolor{red}{-35} & \textcolor{red}{-20} & 0 & 0 & 0 & 0 & 0 \\
\hline
...
\item \textbf{Elemento pivote:} 2 (fila 3, columna 1)
\end{itemize}
...
\item \textbf{Elemento pivote:} 0 (fila 2, columna 3)
\end{itemize}
