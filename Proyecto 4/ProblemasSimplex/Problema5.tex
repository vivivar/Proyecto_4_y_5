...
\large Problema: \textbf{Problema5}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\[ \text{Maximizar } Z = 5x_{1} + 3x_{2} + 1x_{3} \]

\textbf{Sujeto a:}
\begin{align*}
1x_{1} + 1x_{2} + 3x_{3} &\leq 6 \\
5x_{1} + 3x_{2} + 6x_{3} &\leq 15
\end{align*}
...
\hline
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 0 & 5 & 0 & 1 & 15 \\
\hline
\textbf{$S_1$} & 0 & 0 & 0.40 & 1.80 & 1 & 0 & 3 \\
\hline
\textbf{$S_2$} & 0 & 1 & 0.60 & 1.20 & 0 & 1 & 3 \\
\hline
\end{tabular}
\end{center}
...
\hline
 & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$s_1$} & \textbf{$s_2$} & \textbf{L.D.} \\
\hline
\textbf{Z} & 0 & 0 & 5 & 0 & 1 & 15 \\
\hline
\textbf{$s_1$} & 0 & 0.40 & 1.80 & 1 & -0.20 & 3 \\
\hline
\textbf{$x_{1}$} & 1 & 0.60 & 1.20 & 0 & 0.20 & 3 \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
 & \textbf{X1} & \textbf{X2} & \textbf{X3} & \textbf{$s_1$} & \textbf{$s_2$} & \textbf{L.D.} \\
\hline
\textbf{Z} & 0 & 0 & 5 & 0 & 1 & 15 \\
\hline
\textbf{$s$} & -0.67 & 0 & 1 & 1 & -0.33 & 1 \\
\hline
\textbf{$X2$} & 1.67 & 1 & 2 & 0 & 0.33 & 5 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 15$
...
\textbf{Verificación: } $Z = 15$ (mismo valor óptimo)\par\smallskip
