...
\large Problema: \textbf{Problema3}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\textbf{Z} & 1 & 2 & 3 & 0 & 0 & 0 \\
\hline
\textbf{$S_1$} & 0 & 1 & -1 & 1 & 0 & 1 \\
\hline
\textbf{$S_2$} & 0 & 1 & -2 & 0 & 1 & 2 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & \textcolor{red}{2} & \textcolor{red}{3} & 0 & 0 & 0 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 1 & -1 & 1 & 0 & 1 \\
\hline
\textbf{\textcolor{green}{$S_2$}} & 0 & 1 & -2 & 0 & 1 & 2 \\
\hline
\end{tabular}
\end{center}
