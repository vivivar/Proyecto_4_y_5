...
\large Problema: \textbf{cinturoness}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\textbf{Z} & 1 & -3 & -4 & 0 & 0 & 0 \\
\hline
\textbf{$S_1$} & 0 & 1 & 1 & 1 & 0 & 40 \\
\hline
\textbf{$S_2$} & 0 & 1 & 2 & 0 & 1 & 60 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & \textcolor{red}{-3} & \textcolor{red}{-4} & 0 & 0 & 0 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 1 & 1 & 1 & 0 & 40 \\
\hline
\textbf{\textcolor{green}{$S_2$}} & 0 & 1 & 2 & 0 & 1 & 60 \\
\hline
\end{tabular}
\end{center}
...
\item \textbf{Elemento pivote:} 2 (fila 2, columna 2)
\end{itemize}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & \textcolor{red}{-1} & 0 & 0 & 2 & 120 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 0.50 & 0 & 1 & -0.50 & 10 \\
\hline
\textbf{\textcolor{green}{$x_{2}$}} & 0 & 0.50 & \mathbf{[1]} & 0 & 0.50 & 30 \\
\hline
\end{tabular}
\end{center}

\textbf{Variables en la base:} \textcolor{green}{$S_1$}, \textcolor{green}{$x_{2}$}\\
...
\item \textbf{Elemento pivote:} 0,5000 (fila 1, columna 1)
\end{itemize}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 0 & 2 & 1 & 140 \\
\hline
\textbf{\textcolor{green}{$x_{1}$}} & 0 & \mathbf{[1]} & 0 & 2 & -1 & 20 \\
\hline
\textbf{\textcolor{green}{$x_{2}$}} & 0 & 0 & 1 & -1 & 1 & 20 \\
\hline
\end{tabular}
\end{center}

\textbf{Variables en la base:} \textcolor{green}{$x_{1}$}, \textcolor{green}{$x_{2}$}\\
...
\textbf{Z} & 0 & 0 & 2 & 1 & 140 \\
\hline
\textbf{$x_{1}$} & 1 & 0 & 2 & -1 & 20 \\
\hline
\textbf{$x_{2}$} & 0 & 1 & -1 & 1 & 20 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 140$
