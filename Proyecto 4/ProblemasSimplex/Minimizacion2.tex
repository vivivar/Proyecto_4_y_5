...
\large Problema: \textbf{Minimizacion2}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & \textcolor{red}{2} & -1 & 0 & 0 & 0 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 1 & 1 & 1 & 0 & 4 \\
\hline
\textbf{\textcolor{green}{$S_2$}} & 0 & 2 & 1 & 0 & 1 & 5 \\
\hline
\end{tabular}
\end{center}
...
\item \textbf{Elemento pivote:} 2 (fila 2, columna 1)
\end{itemize}
...
\textbf{Z} & 1 & 0 & -2 & 0 & -1 & -5 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 0 & 0.50 & 1 & -0.50 & 1.50 \\
\hline
\textbf{\textcolor{green}{$x_{1}$}} & 0 & \mathbf{[1]} & 0.50 & 0 & 0.50 & 2.50 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Z} & 0 & -2 & 0 & -1 & -5 \\
\hline
\textbf{$s_1$} & 0 & 0.50 & 1 & -0.50 & 1.50 \\
\hline
\textbf{$x_{1}$} & 1 & 0.50 & 0 & 0.50 & 2.50 \\
\hline
\end{tabular}
\end{center}
