...
\large Problema: \textbf{Problema1}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\hline
\textbf{Z} & 1 & 0 & 0 & 0 & 0 & 1 & 2 \\
\hline
\textbf{$S_1$} & 0 & 0 & 2.50 & 1 & 0 & 0 & 3 \\
\hline
\textbf{$S_2$} & 0 & 0 & 0.75 & 0 & 1 & 0 & 0.50 \\
\hline
\textbf{$S_3$} & 0 & 1 & 0.25 & 0 & 0 & 1 & 0.50 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Z} & 0 & 0 & 0 & 0 & 1 & 2 \\
\hline
\textbf{$s_1$} & 0 & 2.50 & 1 & 0 & -0.50 & 3 \\
\hline
\textbf{$s_2$} & 0 & 0.75 & 0 & 1 & -0.25 & 0.50 \\
\hline
\textbf{$x_{1}$} & 1 & 0.25 & 0 & 0 & 0.25 & 0.50 \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
 & \textbf{X1} & \textbf{X2} & \textbf{$s_1$} & \textbf{$s_2$} & \textbf{$s_3$} & \textbf{L.D.} \\
\hline
\textbf{Z} & 0 & 0 & 0 & 0 & 1 & 2 \\
\hline
\textbf{$s$} & 0 & 0 & 1 & -3.33 & 0.33 & 1.33 \\
\hline
\textbf{$X2$} & 0 & 1 & 0 & 1.33 & -0.33 & 0.67 \\
\hline
\textbf{$X1$} & 1 & 0 & 0 & -0.33 & 0.33 & 0.33 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 2$
...
\textbf{Verificación: } $Z = 2$ (mismo valor óptimo)\par\smallskip
