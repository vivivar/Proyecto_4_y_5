...
\item \textbf{Elemento pivote:} 1,0000 (fila 2, columna 1)
\end{itemize}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{$S_3$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & \textcolor{red}{-3} & 0 & 2 & 0 & 4 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 0 & 4 & 1 & -3 & 0 & 0 \\
\hline
\textbf{\textcolor{green}{$x_{1}$}} & 0 & \mathbf{[1]} & -1 & 0 & 1 & 0 & 2 \\
\hline
...
\textbf{Variables en la base:} \textcolor{green}{$S_1$}, \textcolor{green}{$x_{1}$}, \textcolor{green}{$S_3$}\\
...
\item \textbf{Elemento pivote:} 4,0000 (fila 1, columna 2)
\end{itemize}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{$S_3$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 0 & 0.75 & -0.25 & 0 & 4 \\
\hline
\textbf{\textcolor{green}{$x_{2}$}} & 0 & 0 & \mathbf{[1]} & 0.25 & -0.75 & 0 & 0 \\
\hline
\textbf{\textcolor{green}{$x_{1}$}} & 0 & 1 & 0 & 0.25 & 0.25 & 0 & 2 \\
\hline
\textbf{\textcolor{green}{$S_3$}} & 0 & 0 & 0 & -0.25 & 0.75 & 1 & 3 \\
\hline
\end{tabular}
\end{center}

\textbf{Variables en la base:} \textcolor{green}{$x_{2}$}, \textcolor{green}{$x_{1}$}, \textcolor{green}{$S_3$}\\
...
\hline
\textbf{Z} & 0 & 0 & 0.75 & -0.25 & 0 & 4 \\
\hline
\textbf{$x_{2}$} & 0 & 1 & 0.25 & -0.75 & 0 & 0 \\
\hline
\textbf{$x_{1}$} & 1 & 0 & 0.25 & 0.25 & 0 & 2 \\
\hline
\textbf{$s_3$} & 0 & 0 & -0.25 & 0.75 & 1 & 3 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 4$
...
\textbf{Observaciones:} Se detectó degeneración en el problema
