...
\large Problema: \textbf{Problema6}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\[ \text{Maximizar } Z = 2x_{1} -1x_{2} + 1x_{3} \]

\textbf{Sujeto a:}
\begin{align*}
3x_{1} + 1x_{2} + 1x_{3} &\leq 60 \\
1x_{1} -1x_{2} + 2x_{3} &\leq 10 \\
1x_{1} + 1x_{2} -1x_{3} &\leq 20
\end{align*}
...
\hline
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{$S_3$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 0 & 1.50 & 0 & 1.50 & 0.50 & 25 \\
\hline
\textbf{$S_1$} & 0 & 0 & 0 & 1 & 1 & 0 & 0 & 10 \\
\hline
\textbf{$S_2$} & 0 & 1 & 0 & 0.50 & 0 & 1 & 0 & 15 \\
\hline
\textbf{$S_3$} & 0 & 0 & 1 & -1.50 & 0 & 0 & 1 & 5 \\
\hline
\end{tabular}
\end{center}
...
\hline
 & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$s_1$} & \textbf{$s_2$} & \textbf{$s_3$} & \textbf{L.D.} \\
\hline
\textbf{Z} & 0 & 0 & 1.50 & 0 & 1.50 & 0.50 & 25 \\
\hline
\textbf{$s_1$} & 0 & 0 & 1 & 1 & -1 & -2 & 10 \\
\hline
\textbf{$x_{1}$} & 1 & 0 & 0.50 & 0 & 0.50 & 0.50 & 15 \\
\hline
\textbf{$x_{2}$} & 0 & 1 & -1.50 & 0 & -0.50 & 0.50 & 5 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 25$
