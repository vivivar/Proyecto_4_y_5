...
\large Problema: \textbf{Problema4}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\hline
\textbf{Z} & 1 & 0 & 0 & 0 & 0.67 & 2.33 & 16 \\
\hline
\textbf{$S_1$} & 0 & 0 & 0 & 1 & 0 & 0 & 0 \\
\hline
\textbf{$S_2$} & 0 & 1 & 0 & 0 & 1 & 0 & 2 \\
\hline
\textbf{$S_3$} & 0 & 0 & 1 & 0 & 0 & 1 & 2 \\
\hline
\end{tabular}
\end{center}
...
\hline
\textbf{Z} & 0 & 0 & 0 & 0.67 & 2.33 & 16 \\
\hline
\textbf{$s_1$} & 0 & 0 & 1 & -0.67 & -1.33 & 0 \\
\hline
\textbf{$x_{1}$} & 1 & 0 & 0 & 0.33 & -0.33 & 2 \\
\hline
\textbf{$x_{2}$} & 0 & 1 & 0 & -0.33 & 1.33 & 2 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Valor óptimo de la función objetivo: } $Z = 16$

\textbf{Valores de las variables:}
\begin{align*}
x_{1} &= 2 \\
x_{2} &= 2 \\
\textcolor{red}{S_1} &= \textcolor{red}{0} \quad \text{(degenerada)} \\
S_2 &= 0 \\
S_3 &= 0
\end{align*}
