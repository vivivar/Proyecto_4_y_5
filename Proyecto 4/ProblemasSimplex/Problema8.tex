...
\large Problema: \textbf{Problema8}}
\author{
Emily Sánchez\\
Viviana Vargas\\
\\
...
\hline
\textbf{\textcolor{green}{$S_2$}} & 0 & 6 & 5 & 0 & -1 & 0 & 1 & 10 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$x_{4}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 0 & 3 & \textcolor{red}{-2} & 0 & 6 & 60 \\
\hline
\textbf{\textcolor{green}{$S_1$}} & 0 & 0 & 0.17 & -1 & 0.17 & 1 & -0.17 & 3.33 \\
\hline
\textbf{\textcolor{green}{$x_{1}$}} & 0 & \mathbf{[1]} & 0.83 & 0 & -0.17 & 0 & 0.17 & 1.67 \\
\hline
\end{tabular}
\end{center}
...
\item \textbf{Elemento pivote:} 0,1667 (fila 1, columna 4)
\end{itemize}
...
\textbf{Variable} & \textbf{Z} & \textbf{$x_{1}$} & \textbf{$x_{2}$} & \textbf{$x_{3}$} & \textbf{$x_{4}$} & \textbf{$S_1$} & \textbf{$S_2$} & \textbf{b} \\
\hline
\textbf{Z} & 1 & 0 & 2 & \textcolor{red}{-9} & 0 & 12 & 4 & 100 \\
\hline
\textbf{\textcolor{green}{$x_{4}$}} & 0 & 0 & 1 & -6 & \mathbf{[1]} & 6 & -1 & 20 \\
\hline
